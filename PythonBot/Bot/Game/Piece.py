...
class Piece:
    ...
    def turnLeft(self, times=1):
        """Shift into the rotate index to the left. Stops at 0 rotateIndex.
        Boolean return value to indicate success. """
    ...
    def turnRight(self, times=1):
        """ Mirror of left operation. Will not move past the length of rotations.
        Boolean return value to indicate success."""
